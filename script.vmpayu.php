...
if (!defined('_VM_SCRIPT_INCLUDED')) {
	...
	class com_VirtueMart_payu_pluginInstallerScript {
		...
		public function vmInstall () {
			...
			$this->installPlugin('VM - Payment, PayU', 'plugin','payu', 'vmpayment');
			...
			echo "<H3>Installing Virtuemart PayU payment plugin success.</h3>";
			echo "<H3>You may directly uninstall this component. Your plugin will remain</h3>";
			echo "<H3>You may create new payment method as open this path in bach end Joomla menu Components->VirtueMart->Payment methods->Add new, change the payment method option to \"WM - Payment, PayU\", configure the created payment method and save it.</h3>";
